...
def upgrade() -> None:
    ...
    # Add foreign key constraint for users.mpc_wallet_id after both tables exist
    op.create_foreign_key(
        "fk_users_mpc_wallet_id_wallets",
        "users",
        "wallets",
        ["mpc_wallet_id"],
        ["id"],
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint("fk_users_mpc_wallet_id_wallets", "users", type_="foreignkey")
